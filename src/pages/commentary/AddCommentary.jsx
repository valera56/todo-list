              ...
              <input className=''
               value={inpValueName}
                ...
                <input className=''
                 ...
                 <button className='bnt_add'  onClick={handleClick} >add</button>
                 <button className='bnt_add'  onClick={() => setIsCometyru(false)} >x</button>

            </div>
          ) : (
            <div className='block_add' >
               <button className='bnt_add' onClick={() => setIsCometyru(true)}>commentary</button>
            </div> 
          )
         }
         {
